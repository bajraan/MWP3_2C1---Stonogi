...
// 1) trajektoria musi zostać przesunięta do pukut 0,0
// 2) trajektoria musi zostać obrucona względem punkut 0,0
// utworzyć macierze transformacji;
...
//==============================================================================================================
// TRAJEKTORIE PIONOWE NAK┼üADAJ─äCE SI─ś
//==============================================================================================================
//        |        |       |  exp        |
//   P1   |   P2   | speed |  collision  |  Descriptions
//        |        |       |             |
    ...
    0,-2  ,  0,-1  ,   1   , collisionYES, "     KOL - Trajektorie PIONOWE sie nakladaja, kol w CP(0,3) po 2s || ST1 dogoni┼éa ST2",
...
//        |        |       |             |
     0,0  ,  -1,1  ,   1   , // TC24
     0,1  ,   1,2  ,   1   , collisionYES,"KOLIZJA SKOSÜNA, KOLIZJA GRANICZNA (KONIC Z POCZATKIEM)",
